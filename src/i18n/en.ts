export const en = {
  ...
  historyStudies: 'Known studies',
  historyStudiesCheck: '✓',
  historyStudiesAllFoundOne: 'The study was found',
  historyStudiesAllFound: 'All {total} studies found',
  historyStudiesNotFound: 'Not found: {list}',
  historyStudiesUnresolved: 'Unresolved: {list}',
  historyStudiesNone: 'No studies checked',
